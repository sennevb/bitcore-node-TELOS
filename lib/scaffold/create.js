...
var BASE_PACKAGE = {
  description: 'A full XBTS node build with Bitcore',
  repository: 'https://github.com/sennevb/bitcore-node-TELOS',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-XBTS': 'sennevb/bitcore-lib-TELOS',
    'bitcore-node-XBTS': 'sennevb/bitcore-node-TELOS'
  }
};
