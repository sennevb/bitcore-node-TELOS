...
```bash
git clone https://github.com/sennevb/bitcore-node-TELOS.git
cd bitcore-node-TELOS
npm install
bitcore-node start
```
...
- [Insight API](https://github.com/sennevb/insight-api-TELOS)
- [Insight UI](https://github.com/sennevb/insight-ui-TELOS)
